// src/data/useRabbitMQMachineData.js
import { useEffect, useState } from "react";
import rabbitmqService from "../services/rabbitmqServices";

export function useRabbitMQMachineData(machineId) {
  ...
  useEffect(() => {
    ...
    // This will be converted to: factory.machine.{machineId} for RabbitMQ routing
    const topic = `factory/machine/${machineId}`;

    // Subscribe to the machine-specific queue/topic
    const unsubscribe = rabbitmqService.subscribe(topic, (mqttData) => {
      setData({
